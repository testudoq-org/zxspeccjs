...
The canonical enforcement appendix is maintained in `.github/copilot-instructions.md` (see the **"Additional Quality, Test & Codacy Enforcement Rules"** section). To avoid duplication and ensure a single source of truth, please consult that file for the mandatory pre-commit reminder and the full enforcement rules.
