...
// Long diagnostic moved to tests/scripts/test_channels.mjs
// Excluded from unit runs; run the script directly from `tests/scripts/test_channels.mjs`.

test.skip('test_channels moved to tests/scripts (long diagnostic)', () => {
